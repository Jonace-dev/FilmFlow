...
class AppDelegate: NSObject, UIApplicationDelegate  {
    ...
    /// Handles required actions upon app launch
...
//        Style.configLoading()
    ...
    private func goToSplashView() {
        ...
        let navigationController: UINavigationController = UINavigationController(rootViewController: UIHostingController(rootView: splashView))
